...
export default function BoothInput() {
  ...
  function handleSave() {
    ...
    const finalPrizeName = inp.prize_name || last?.prize_name || ''
    ...
    saveDraft({
      ...
      prize_name: finalPrizeName, note: inp.note||''
    })
    ...
    <div className="container" style={{paddingTop:16}}>
      ...
      <div className="card">
        ...
        <div style={{marginBottom:16}}>
          ...
          {inDiff === 0 && usingLastIn && (
            <div className="diff normal" style={{marginTop:6}}>前回値のまま保存されます</div>
          )}
        </div>
