      ...
      {imgLargeUrl && (
        ...
        >
          ...
          <button
            type="button"
            onClick={() => setImgLargeUrl(null)}
            className="absolute top-4 right-4 text-white text-2xl font-bold leading-none bg-black/40 rounded-full w-9 h-9 flex items-center justify-center"
          >✕</button>
        </div>
      )}
    </div>
