# FIX_GUIDE v5: bayside (ベイサイドプレイス博多)
...
- `possible_2nd_round`: 22 件 — 1日2回巡回の可能性(4ブース×2回=8行)
- `possible_aggregate`: 20 件 — 集計行/棚卸混入の可能性(booth≥9)

## 機械別詳細(max_booth 降順)

| machine | area | unit | max_booth | anomaly行 | 支配タグ |
|---|---|---:|---:|---:|---|
| BUZZ③ | - | U1 | **28** | 24 | possible_aggregate(20), possible_2nd_round(4) |
| BUZZミニ② | - | U1 | **7** | 12 | possible_2nd_round(12) |
| BUZZ④ | - | U1 | **6** | 2 | possible_2nd_round(2) |
| BUZZ⑤ | - | U1 | **6** | 2 | possible_2nd_round(2) |
...
- `docs/sheets/_anomaly_v5/bayside_anomaly.csv` を開いて Excel と突き合わせ。
