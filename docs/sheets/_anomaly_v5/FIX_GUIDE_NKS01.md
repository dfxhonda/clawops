...
- `possible_2nd_round`: 11 件 — 1日2回巡回の可能性(4ブース×2回=8行)

## 機械別詳細(max_booth 降順)

| machine | area | unit | max_booth | anomaly行 | 支配タグ |
|---|---|---:|---:|---:|---|
| BuZZ DX② | - | U1 | **8** | 8 | possible_2nd_round(8) |
| BUZZ① | - | U1 | **5** | 3 | possible_2nd_round(3) |
...
- `docs/sheets/_anomaly_v5/NKS01_anomaly.csv` を開いて Excel と突き合わせ。
