...
|---|---|---:|---:|---:|---|
| BUZZ③ | - | U1 | **28** | 24 | 棚卸/履歴データ混入 |
| BUZZミニ② | - | U1 | **7** | 12 | 日付記入漏れで継承暴走 |
| BUZZ④ | - | U1 | **6** | 2 | 日付記入漏れで継承暴走 |
| BUZZ⑤ | - | U1 | **6** | 2 | 日付記入漏れで継承暴走 |
...
- `docs/sheets/_anomaly/bayside_anomaly.csv` 開いて、Excel ファイルと突き合わせ。
